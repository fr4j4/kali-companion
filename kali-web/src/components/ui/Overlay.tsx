...
export function Overlay({
  ...
  const panelClasses = isModal
    ? `bg-elevated border-border rounded-xl shadow-xl ${sizeMap[size]} ${panelClassName ?? ""} max-h-[85vh] h-auto overflow-hidden flex flex-col`
    : effectiveVariant === "sheet-bottom"
      ? `bg-elevated border-t border-border rounded-t-sheet max-h-[85vh] h-auto overflow-auto scrollbar-thin ${panelClassName ?? ""}`
