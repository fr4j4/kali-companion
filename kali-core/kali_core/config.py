...
llm_system_prompt: str = os.getenv(
    ...
    (
        ...
        "- create_terminal_session: Crea una sesión de terminal con nombre\n"
        "  descriptivo antes de ejecutar múltiples comandos relacionados\n"
        "  (ej: 'Deploy backend', 'Debug compile error', 'Install deps').\n"
        "  Pasa el terminal_session_id retornado a los run_command posteriores.\n"
        "  Para un solo comando aislado, llama run_command directamente sin\n"
        "  crear sesión.\n"
