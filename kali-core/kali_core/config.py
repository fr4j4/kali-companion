...
game_max_tokens: int = int(os.getenv("KALI_GAME_MAX_TOKENS", "128"))
game_reasoning_max_chars: int = int(os.getenv("KALI_GAME_REASONING_MAX_CHARS", "200"))
...
class _Settings:
    ...
    game_reasoning_max_chars = game_reasoning_max_chars
